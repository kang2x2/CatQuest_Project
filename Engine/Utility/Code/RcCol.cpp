...
CRcCol::CRcCol(LPDIRECT3DDEVICE9 pGraphicDev)
	:  CVIBuffer(pGraphicDev, COMPONENT_TYPE::BUFFER_RC_COL)
{
}

CRcCol::CRcCol(const CRcCol & rhs, CGameObject* _pOwnerObject)
...
CComponent * CRcCol::Clone(CGameObject* _pOwnerObject)
{
	return new CRcCol(*this, _pOwnerObject);
}
