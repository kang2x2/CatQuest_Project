...
CRcTex::CRcTex(LPDIRECT3DDEVICE9 pGraphicDev)
	:  CVIBuffer(pGraphicDev, COMPONENT_TYPE::BUFFER_RC_TEX)
{
}

CRcTex::CRcTex(const CRcTex & rhs, CGameObject* _pOwnerObject)
...
CComponent * CRcTex::Clone(CGameObject* _pOwnerObject)
{
	return new CRcTex(*this, _pOwnerObject);
}
