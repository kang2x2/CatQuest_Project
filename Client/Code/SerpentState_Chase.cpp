...
CSerpentState_Chase::CSerpentState_Chase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CSerpentState_Chase::~CSerpentState_Chase()
{
}

HRESULT CSerpentState_Chase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CSerpentState_Chase::Update_State(const _float& fTimeDelta)
{
...
void CSerpentState_Chase::LateUpdate_State()
{
    
}

void CSerpentState_Chase::Render_State()
{
   
}

STATE_TYPE CSerpentState_Chase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CSerpentState_Chase* CSerpentState_Chase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CSerpentState_Chase* pInstance = new CSerpentState_Chase(pGraphicDev);
