...
CFishState_bRest::~CFishState_bRest()
{
}

HRESULT CFishState_bRest::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CFishState_bRest::Update_State(const _float& fTimeDelta)
{
...
void CFishState_bRest::LateUpdate_State()
{

}

void CFishState_bRest::Render_State()
{
    
}

STATE_TYPE CFishState_bRest::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CFishState_bRest* CFishState_bRest::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CFishState_bRest* pInstance = new CFishState_bRest(pGraphicDev);
