...
CFishState_Chase::CFishState_Chase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CFishState_Chase::~CFishState_Chase()
{
}

HRESULT CFishState_Chase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CFishState_Chase::Update_State(const _float& fTimeDelta)
{
...
void CFishState_Chase::LateUpdate_State()
{
    
}

void CFishState_Chase::Render_State()
{
   
}

STATE_TYPE CFishState_Chase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CFishState_Chase* CFishState_Chase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CFishState_Chase* pInstance = new CFishState_Chase(pGraphicDev);
