...
CHedgehogState_Rest::~CHedgehogState_Rest()
{
}

HRESULT CHedgehogState_Rest::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CHedgehogState_Rest::Update_State(const _float& fTimeDelta)
{
...
void CHedgehogState_Rest::LateUpdate_State()
{

}

void CHedgehogState_Rest::Render_State()
{
    
}

STATE_TYPE CHedgehogState_Rest::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CHedgehogState_Rest* CHedgehogState_Rest::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CHedgehogState_Rest* pInstance = new CHedgehogState_Rest(pGraphicDev);
