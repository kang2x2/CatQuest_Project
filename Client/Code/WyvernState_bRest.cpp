...
CWyvernState_bRest::CWyvernState_bRest(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CWyvernState_bRest::~CWyvernState_bRest()
{
}

HRESULT CWyvernState_bRest::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CWyvernState_bRest::Update_State(const _float& fTimeDelta)
{
...
void CWyvernState_bRest::LateUpdate_State()
{

}

void CWyvernState_bRest::Render_State()
{
    
}

STATE_TYPE CWyvernState_bRest::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CWyvernState_bRest* CWyvernState_bRest::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CWyvernState_bRest* pInstance = new CWyvernState_bRest(pGraphicDev);
