...
CWyvernRedState_Patrol::CWyvernRedState_Patrol(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CWyvernRedState_Patrol::~CWyvernRedState_Patrol()
{
}

HRESULT CWyvernRedState_Patrol::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CWyvernRedState_Patrol::Update_State(const _float& fTimeDelta)
{
...
void CWyvernRedState_Patrol::LateUpdate_State()
{

}

void CWyvernRedState_Patrol::Render_State()
{
    
}

STATE_TYPE CWyvernRedState_Patrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CWyvernRedState_Patrol* CWyvernRedState_Patrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CWyvernRedState_Patrol* pInstance = new CWyvernRedState_Patrol(pGraphicDev);
...
void CWyvernRedState_Patrol::Free()
{
    __super::Free();
}
