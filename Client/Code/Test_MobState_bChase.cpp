...
CTest_MobState_bChase::CTest_MobState_bChase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CTest_MobState_bChase::~CTest_MobState_bChase()
{
}

HRESULT CTest_MobState_bChase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CTest_MobState_bChase::Update_State(const _float& fTimeDelta)
{
...
void CTest_MobState_bChase::LateUpdate_State()
{
    
}

void CTest_MobState_bChase::Render_State()
{
   
}

STATE_TYPE CTest_MobState_bChase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CTest_MobState_bChase* CTest_MobState_bChase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CTest_MobState_bChase* pInstance = new CTest_MobState_bChase(pGraphicDev);
...
void CTest_MobState_bChase::Free()
{
    __super::Free();
}
