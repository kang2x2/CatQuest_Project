...
CTest_MobState_Patrol::CTest_MobState_Patrol(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CTest_MobState_Patrol::~CTest_MobState_Patrol()
{
}

HRESULT CTest_MobState_Patrol::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CTest_MobState_Patrol::Update_State(const _float& fTimeDelta)
{
    // Monster - Ai Com
...
void CTest_MobState_Patrol::LateUpdate_State()
{

}

void CTest_MobState_Patrol::Render_State()
{
    
}

STATE_TYPE CTest_MobState_Patrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CTest_MobState_Patrol* CTest_MobState_Patrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CTest_MobState_Patrol* pInstance = new CTest_MobState_Patrol(pGraphicDev);
...
void CTest_MobState_Patrol::Free()
{
    __super::Free();
}
