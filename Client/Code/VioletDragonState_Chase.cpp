...
CVioletDragonState_Chase::CVioletDragonState_Chase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CVioletDragonState_Chase::~CVioletDragonState_Chase()
{
}

HRESULT CVioletDragonState_Chase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CVioletDragonState_Chase::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_Chase::LateUpdate_State()
{
    
}

void CVioletDragonState_Chase::Render_State()
{
   
}

STATE_TYPE CVioletDragonState_Chase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_Chase* CVioletDragonState_Chase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_Chase* pInstance = new CVioletDragonState_Chase(pGraphicDev);
...
void CVioletDragonState_Chase::Free()
{
    __super::Free();
}
