...
CVioletDragonState_Dash_Attack_Back::CVioletDragonState_Dash_Attack_Back(LPDIRECT3DDEVICE9 pGraphicDev)
	:CState(pGraphicDev)
	, m_fAccTime(0.f)
{
}

CVioletDragonState_Dash_Attack_Back::~CVioletDragonState_Dash_Attack_Back()
{
}

HRESULT CVioletDragonState_Dash_Attack_Back::Ready_State(CStateMachine* pOwner)
{
	if (nullptr != pOwner)
	{
		m_pOwner = pOwner;
	}
	m_eState = STATE_TYPE::BOSS_DASH_BACK_ATTACK;
...
STATE_TYPE CVioletDragonState_Dash_Attack_Back::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_Dash_Attack_Back::LateUpdate_State()
{
}

void CVioletDragonState_Dash_Attack_Back::Render_State()
{
}

STATE_TYPE CVioletDragonState_Dash_Attack_Back::Key_Input(const _float& fTimeDelta)
{
    return m_eState;
}

CVioletDragonState_Dash_Attack_Back* CVioletDragonState_Dash_Attack_Back::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_Dash_Attack_Back* pInstance = new CVioletDragonState_Dash_Attack_Back(pGraphicDev);
...
void CVioletDragonState_Dash_Attack_Back::Free()
{
    __super::Free();
}
