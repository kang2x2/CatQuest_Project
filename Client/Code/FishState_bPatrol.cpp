...
CFishState_bPatrol::~CFishState_bPatrol()
{
}

HRESULT CFishState_bPatrol::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CFishState_bPatrol::Update_State(const _float& fTimeDelta)
{
...
void CFishState_bPatrol::LateUpdate_State()
{

}

void CFishState_bPatrol::Render_State()
{
    
}

STATE_TYPE CFishState_bPatrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CFishState_bPatrol* CFishState_bPatrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CFishState_bPatrol* pInstance = new CFishState_bPatrol(pGraphicDev);
