...
CEffect_Beam::CEffect_Beam(const CEffect& rhs)
	: CSkillEffect(rhs)
{
}

CEffect_Beam::~CEffect_Beam()
{
}

HRESULT CEffect_Beam::Ready_Object()
{
...
_int CEffect_Beam::Update_Object(const _float& fTimeDelta)
{
...
void CEffect_Beam::LateUpdate_Object()
{
	__super::LateUpdate_Object();
}

void CEffect_Beam::Render_Object()
{
	__super::Render_Object();
}

void CEffect_Beam::Play_Effect(const _vec3& _vPos, const _vec3& _vSize)
{
...
HRESULT CEffect_Beam::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Texture(L"Proto_Texture_Effect_Skill_Beam", this));
...
CEffect_Beam* CEffect_Beam::Create(LPDIRECT3DDEVICE9 pGraphicDev, CGameObject* _pOwnerObject)
{
	CEffect_Beam* pInstance = new CEffect_Beam(pGraphicDev, _pOwnerObject);
