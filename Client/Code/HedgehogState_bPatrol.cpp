...
CHedgehogState_bPatrol::CHedgehogState_bPatrol(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CHedgehogState_bPatrol::~CHedgehogState_bPatrol()
{
}

HRESULT CHedgehogState_bPatrol::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CHedgehogState_bPatrol::Update_State(const _float& fTimeDelta)
{
...
void CHedgehogState_bPatrol::LateUpdate_State()
{

}

void CHedgehogState_bPatrol::Render_State()
{
    
}

STATE_TYPE CHedgehogState_bPatrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CHedgehogState_bPatrol* CHedgehogState_bPatrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CHedgehogState_bPatrol* pInstance = new CHedgehogState_bPatrol(pGraphicDev);
...
void CHedgehogState_bPatrol::Free()
{
    __super::Free();
}
