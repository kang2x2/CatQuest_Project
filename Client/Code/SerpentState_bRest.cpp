...
CSerpentState_bRest::CSerpentState_bRest(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CSerpentState_bRest::~CSerpentState_bRest()
{
}

HRESULT CSerpentState_bRest::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CSerpentState_bRest::Update_State(const _float& fTimeDelta)
{
...
void CSerpentState_bRest::LateUpdate_State()
{

}

void CSerpentState_bRest::Render_State()
{
    
}

STATE_TYPE CSerpentState_bRest::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CSerpentState_bRest* CSerpentState_bRest::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CSerpentState_bRest* pInstance = new CSerpentState_bRest(pGraphicDev);
