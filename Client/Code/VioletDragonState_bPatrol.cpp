...
CVioletDragonState_bPatrol::CVioletDragonState_bPatrol(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CVioletDragonState_bPatrol::~CVioletDragonState_bPatrol()
{
}

HRESULT CVioletDragonState_bPatrol::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CVioletDragonState_bPatrol::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_bPatrol::LateUpdate_State()
{

}

void CVioletDragonState_bPatrol::Render_State()
{
    
}

STATE_TYPE CVioletDragonState_bPatrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_bPatrol* CVioletDragonState_bPatrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CVioletDragonState_bPatrol* pInstance = new CVioletDragonState_bPatrol(pGraphicDev);
...
void CVioletDragonState_bPatrol::Free()
{
    __super::Free();
}
