...
CWyvernRedState_ComeBack::CWyvernRedState_ComeBack(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CWyvernRedState_ComeBack::~CWyvernRedState_ComeBack()
{
}

HRESULT CWyvernRedState_ComeBack::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CWyvernRedState_ComeBack::Update_State(const _float& fTimeDelta)
{
...
void CWyvernRedState_ComeBack::LateUpdate_State()
{
    
}

void CWyvernRedState_ComeBack::Render_State()
{
   

}

STATE_TYPE CWyvernRedState_ComeBack::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CWyvernRedState_ComeBack* CWyvernRedState_ComeBack::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CWyvernRedState_ComeBack* pInstance = new CWyvernRedState_ComeBack(pGraphicDev);
...
void CWyvernRedState_ComeBack::Free()
{
    __super::Free();
}
