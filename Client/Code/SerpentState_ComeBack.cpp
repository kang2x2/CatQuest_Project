...
CSerpentState_ComeBack::CSerpentState_ComeBack(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CSerpentState_ComeBack::~CSerpentState_ComeBack()
{
}

HRESULT CSerpentState_ComeBack::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CSerpentState_ComeBack::Update_State(const _float& fTimeDelta)
{
...
void CSerpentState_ComeBack::LateUpdate_State()
{
    
}

void CSerpentState_ComeBack::Render_State()
{
   

}

STATE_TYPE CSerpentState_ComeBack::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CSerpentState_ComeBack* CSerpentState_ComeBack::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CSerpentState_ComeBack* pInstance = new CSerpentState_ComeBack(pGraphicDev);
...
void CSerpentState_ComeBack::Free()
{
    __super::Free();
}
