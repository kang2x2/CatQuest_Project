...
CSerpentState_Patrol::CSerpentState_Patrol(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CSerpentState_Patrol::~CSerpentState_Patrol()
{
}

HRESULT CSerpentState_Patrol::Ready_State(CStateMachine* pOwner)
{
...
STATE_TYPE CSerpentState_Patrol::Update_State(const _float& fTimeDelta)
{
...
void CSerpentState_Patrol::LateUpdate_State()
{

}

void CSerpentState_Patrol::Render_State()
{
    
}

STATE_TYPE CSerpentState_Patrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CSerpentState_Patrol* CSerpentState_Patrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CSerpentState_Patrol* pInstance = new CSerpentState_Patrol(pGraphicDev);
...
void CSerpentState_Patrol::Free()
{
    __super::Free();
}
