...
CWyvernRedState_bPatrol::CWyvernRedState_bPatrol(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CWyvernRedState_bPatrol::~CWyvernRedState_bPatrol()
{
}

HRESULT CWyvernRedState_bPatrol::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CWyvernRedState_bPatrol::Update_State(const _float& fTimeDelta)
{
...
void CWyvernRedState_bPatrol::LateUpdate_State()
{

}

void CWyvernRedState_bPatrol::Render_State()
{
    
}

STATE_TYPE CWyvernRedState_bPatrol::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CWyvernRedState_bPatrol* CWyvernRedState_bPatrol::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
 {
    CWyvernRedState_bPatrol* pInstance = new CWyvernRedState_bPatrol(pGraphicDev);
...
void CWyvernRedState_bPatrol::Free()
{
    __super::Free();
}
