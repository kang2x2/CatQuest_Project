...
CVioletDragonState_bAttack2::CVioletDragonState_bAttack2(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CVioletDragonState_bAttack2::~CVioletDragonState_bAttack2()
{
}

HRESULT CVioletDragonState_bAttack2::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
    }
    m_eState = STATE_TYPE::BOSS_BACK_ATTACK2;
...
STATE_TYPE CVioletDragonState_bAttack2::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_bAttack2::LateUpdate_State()
{

}

void CVioletDragonState_bAttack2::Render_State()
{
    
}

STATE_TYPE CVioletDragonState_bAttack2::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_bAttack2* CVioletDragonState_bAttack2::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_bAttack2* pInstance = new CVioletDragonState_bAttack2(pGraphicDev);
...
void CVioletDragonState_bAttack2::Free()
{
    __super::Free();
}
