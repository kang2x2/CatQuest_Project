...
CVioletDragonState_bChase3::CVioletDragonState_bChase3(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CVioletDragonState_bChase3::~CVioletDragonState_bChase3()
{
}

HRESULT CVioletDragonState_bChase3::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
    }
    m_eState = STATE_TYPE::BOSS_BACK_CHASE3;
...
STATE_TYPE CVioletDragonState_bChase3::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_bChase3::LateUpdate_State()
{
    
}

void CVioletDragonState_bChase3::Render_State()
{
   
}

STATE_TYPE CVioletDragonState_bChase3::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_bChase3* CVioletDragonState_bChase3::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_bChase3* pInstance = new CVioletDragonState_bChase3(pGraphicDev);
...
void CVioletDragonState_bChase3::Free()
{
    __super::Free();
}
