...
CHitEffect_Red::CHitEffect_Red(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& _pPos)
    : CEffect(pGraphicDev, OBJ_ID::EFFECT_HIT_RED)
{
    m_vPos = _pPos;

}

CHitEffect_Red::CHitEffect_Red(const CEffect& rhs)
    : CEffect(rhs)
{
}

CHitEffect_Red::~CHitEffect_Red()
{
}

HRESULT CHitEffect_Red::Ready_Object()
{
...
_int CHitEffect_Red::Update_Object(const _float& fTimeDelta)
{
...
void CHitEffect_Red::LateUpdate_Object()
{
...
void CHitEffect_Red::Render_Object()
{
...
HRESULT CHitEffect_Red::Add_Component()
{
...
CHitEffect_Red* CHitEffect_Red::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& _pPos)
{
	CHitEffect_Red* pInstance = new CHitEffect_Red(pGraphicDev, _pPos);
