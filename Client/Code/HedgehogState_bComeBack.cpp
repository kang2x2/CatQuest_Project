...
CHedgehogState_bComeBack::~CHedgehogState_bComeBack()
{
}

HRESULT CHedgehogState_bComeBack::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CHedgehogState_bComeBack::Update_State(const _float& fTimeDelta)
{
...
void CHedgehogState_bComeBack::LateUpdate_State()
{
    
}

void CHedgehogState_bComeBack::Render_State()
{
   

}

STATE_TYPE CHedgehogState_bComeBack::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CHedgehogState_bComeBack* CHedgehogState_bComeBack::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CHedgehogState_bComeBack* pInstance = new CHedgehogState_bComeBack(pGraphicDev);
...
void CHedgehogState_bComeBack::Free()
{
    __super::Free();
}
