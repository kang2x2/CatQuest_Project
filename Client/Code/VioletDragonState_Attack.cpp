...
CVioletDragonState_Attack::~CVioletDragonState_Attack()
{
}

HRESULT CVioletDragonState_Attack::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CVioletDragonState_Attack::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_Attack::LateUpdate_State()
{

}

void CVioletDragonState_Attack::Render_State()
{
    
}

STATE_TYPE CVioletDragonState_Attack::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_Attack* CVioletDragonState_Attack::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_Attack* pInstance = new CVioletDragonState_Attack(pGraphicDev);
...
void CVioletDragonState_Attack::Free()
{
    __super::Free();
}
