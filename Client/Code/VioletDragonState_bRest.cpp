...
CVioletDragonState_bRest::~CVioletDragonState_bRest()
{
}

HRESULT CVioletDragonState_bRest::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CVioletDragonState_bRest::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_bRest::LateUpdate_State()
{

}

void CVioletDragonState_bRest::Render_State()
{
    
}

STATE_TYPE CVioletDragonState_bRest::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_bRest* CVioletDragonState_bRest::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_bRest* pInstance = new CVioletDragonState_bRest(pGraphicDev);
...
void CVioletDragonState_bRest::Free()
{
    __super::Free();
}
