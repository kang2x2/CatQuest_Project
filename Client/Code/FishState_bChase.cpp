...
CFishState_bChase::CFishState_bChase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CFishState_bChase::~CFishState_bChase()
{
}

HRESULT CFishState_bChase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CFishState_bChase::Update_State(const _float& fTimeDelta)
{
...
void CFishState_bChase::LateUpdate_State()
{
    
}

void CFishState_bChase::Render_State()
{
   
}

STATE_TYPE CFishState_bChase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CFishState_bChase* CFishState_bChase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CFishState_bChase* pInstance = new CFishState_bChase(pGraphicDev);
