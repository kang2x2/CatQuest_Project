...
CTree::CTree(LPDIRECT3DDEVICE9 pGraphicDev, const OBJ_ID& _eID)
...
void CTree::LateUpdate_Object()
{
	__super::LateUpdate_Object();
}

void CTree::Render_Object()
{
...
void CTree::Play_ColLogic(const _float& fTimeDelta)
{
}
