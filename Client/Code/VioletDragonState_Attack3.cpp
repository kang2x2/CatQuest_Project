...
CVioletDragonState_Attack3::CVioletDragonState_Attack3(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CVioletDragonState_Attack3::~CVioletDragonState_Attack3()
{
}

HRESULT CVioletDragonState_Attack3::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
    }
    m_eState = STATE_TYPE::BOSS_ATTACK3;
...
STATE_TYPE CVioletDragonState_Attack3::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_Attack3::LateUpdate_State()
{

}

void CVioletDragonState_Attack3::Render_State()
{
    
}

STATE_TYPE CVioletDragonState_Attack3::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_Attack3* CVioletDragonState_Attack3::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_Attack3* pInstance = new CVioletDragonState_Attack3(pGraphicDev);
...
void CVioletDragonState_Attack3::Free()
{
    __super::Free();
}
