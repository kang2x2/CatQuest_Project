...
CFishState_Rest::CFishState_Rest(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CFishState_Rest::~CFishState_Rest()
{
}

HRESULT CFishState_Rest::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CFishState_Rest::Update_State(const _float& fTimeDelta)
{
...
void CFishState_Rest::LateUpdate_State()
{

}

void CFishState_Rest::Render_State()
{
    
}

STATE_TYPE CFishState_Rest::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CFishState_Rest* CFishState_Rest::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CFishState_Rest* pInstance = new CFishState_Rest(pGraphicDev);
