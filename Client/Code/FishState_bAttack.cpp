...
CFishState_bAttack::~CFishState_bAttack()
{
}

HRESULT CFishState_bAttack::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CFishState_bAttack::Update_State(const _float& fTimeDelta)
{
...
void CFishState_bAttack::LateUpdate_State()
{

}

void CFishState_bAttack::Render_State()
{
    
}

STATE_TYPE CFishState_bAttack::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CFishState_bAttack* CFishState_bAttack::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CFishState_bAttack* pInstance = new CFishState_bAttack(pGraphicDev);
