...
CHedgehogState_bChase::~CHedgehogState_bChase()
{
}

HRESULT CHedgehogState_bChase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CHedgehogState_bChase::Update_State(const _float& fTimeDelta)
{
...
void CHedgehogState_bChase::LateUpdate_State()
{
    
}

void CHedgehogState_bChase::Render_State()
{
   
}

STATE_TYPE CHedgehogState_bChase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CHedgehogState_bChase* CHedgehogState_bChase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CHedgehogState_bChase* pInstance = new CHedgehogState_bChase(pGraphicDev);
...
void CHedgehogState_bChase::Free()
{
    __super::Free();
}
