...
CSerpentState_bChase::CSerpentState_bChase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CSerpentState_bChase::~CSerpentState_bChase()
{
}

HRESULT CSerpentState_bChase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CSerpentState_bChase::Update_State(const _float& fTimeDelta)
{
...
void CSerpentState_bChase::LateUpdate_State()
{
    
}

void CSerpentState_bChase::Render_State()
{
   
}

STATE_TYPE CSerpentState_bChase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CSerpentState_bChase* CSerpentState_bChase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CSerpentState_bChase* pInstance = new CSerpentState_bChase(pGraphicDev);
...
void CSerpentState_bChase::Free()
{
    __super::Free();
}
