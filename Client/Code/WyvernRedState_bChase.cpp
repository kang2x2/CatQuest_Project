...
CWyvernRedState_bChase::CWyvernRedState_bChase(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CWyvernRedState_bChase::~CWyvernRedState_bChase()
{
}

HRESULT CWyvernRedState_bChase::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CWyvernRedState_bChase::Update_State(const _float& fTimeDelta)
{
...
void CWyvernRedState_bChase::LateUpdate_State()
{
    
}

void CWyvernRedState_bChase::Render_State()
{
   
}

STATE_TYPE CWyvernRedState_bChase::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CWyvernRedState_bChase* CWyvernRedState_bChase::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CWyvernRedState_bChase* pInstance = new CWyvernRedState_bChase(pGraphicDev);
...
void CWyvernRedState_bChase::Free()
{
    __super::Free();
}
