...
CMountain::CMountain(LPDIRECT3DDEVICE9 pGraphicDev, const OBJ_ID& _eID)
	: CEnvironment(pGraphicDev, _eID)
{
}

CMountain::CMountain(const CMountain& rhs)
	: CEnvironment(rhs)
{
}
...
void CMountain::Play_ColLogic(const _float& fTimeDelta)
{
}
