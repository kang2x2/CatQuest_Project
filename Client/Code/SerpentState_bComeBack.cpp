...
CSerpentState_bComeBack::CSerpentState_bComeBack(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CSerpentState_bComeBack::~CSerpentState_bComeBack()
{
}

HRESULT CSerpentState_bComeBack::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
...
STATE_TYPE CSerpentState_bComeBack::Update_State(const _float& fTimeDelta)
{
...
void CSerpentState_bComeBack::LateUpdate_State()
{
    
}

void CSerpentState_bComeBack::Render_State()
{
   

}

STATE_TYPE CSerpentState_bComeBack::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CSerpentState_bComeBack* CSerpentState_bComeBack::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CSerpentState_bComeBack* pInstance = new CSerpentState_bComeBack(pGraphicDev);
...
void CSerpentState_bComeBack::Free()
{
    __super::Free();
}
