...
CVioletDragonState_bChase2::CVioletDragonState_bChase2(LPDIRECT3DDEVICE9 pGraphicDev)
    : CState(pGraphicDev)
    , m_fAccTime(0.f)
    , m_fChaseRange(0.f)
...
CVioletDragonState_bChase2::~CVioletDragonState_bChase2()
{
}

HRESULT CVioletDragonState_bChase2::Ready_State(CStateMachine* pOwner)
{
    if (nullptr != pOwner)
    {
        m_pOwner = pOwner;
    }
    m_eState = STATE_TYPE::BOSS_BACK_CHASE2;
...
STATE_TYPE CVioletDragonState_bChase2::Update_State(const _float& fTimeDelta)
{
...
void CVioletDragonState_bChase2::LateUpdate_State()
{
    
}

void CVioletDragonState_bChase2::Render_State()
{
   
}

STATE_TYPE CVioletDragonState_bChase2::Key_Input(const _float& fTimeDelta)
{
 
    return m_eState;
}

CVioletDragonState_bChase2* CVioletDragonState_bChase2::Create(LPDIRECT3DDEVICE9 pGraphicDev, CStateMachine* pOwner)
{
    CVioletDragonState_bChase2* pInstance = new CVioletDragonState_bChase2(pGraphicDev);
...
void CVioletDragonState_bChase2::Free()
{
    __super::Free();
}
